<template>
	<view class="index">
		<view class="grid">
			<view  style="font-size: 15px;display: flex;align-items: center;justify-content: space-between;margin-bottom: 15px;color: #12a0de;width: 90%;height: 80rpx;margin-left: 5%;margin-top: 30rpx;">
				<label style="color: #999999;font-size: 25rpx;">班级:</label>
				<picker @change="bindPickerChange" :value="index" :range="array" range-key="name"  style="background-color: #f7f7f7;display: flex;justify-content: center;width: 73%;height: 70rpx;border-radius: 20rpx;align-items: center;">
